defmodule BusTerminalSystem.Database.Tables.Transactions do

  use Endon
  use Ecto.Schema
  import Ecto.Changeset

  @db_columns [:srcAcc, :srcBranch, :srcCurrency, :transferTyp, :transferRef, :referenceNo, :destAcc, :destBranch,
  ...
  schema "probase_tbl_bank_transactions" do
    field :srcAcc, :string

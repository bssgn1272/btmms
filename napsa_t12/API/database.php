...
public function insertBarcode($barcode){
	...
	$statment = "INSERT INTO boarding_now (Barcode_number) VALUES('$barcode')";
...
public function insertCustomer($fname,$lname,$phone_number){
	$this->logger->log("Calling the insertLuggage function",Configs::INFO);
	$connection = $this->createConnection();
$statment ="INSERT INTO customer(customer_id,fname,lname,phone_number) VALUES ( NULL,'$fname', '$lname', '$phone_number')";
...
public function insertLuggage2($fname,$lname,$description,$weight,$phone_number,$Destination){
	$this->logger->log("Calling the insertLuggage function",Configs::INFO);
	$connection = $this->createConnection();
	...
	$this->logger->log("Calling the insertLuggage function",Configs::INFO);
	$connection = $this->createConnection();
	$statment = "INSERT INTO rate (id,Rate) VALUES ( null,'$PriceRate',)";
 ...
 public function getPriceRate(){
        $this->logger->log("Calling the getpricerate function",Configs::INFO);
        $connection = $this->createConnection();
        $statment = "SELECT * FROM rate";

        $this->logger->log("the statement to run is ".$statment,Configs::INFO);

	$result =mysqli_query($connection, $statment);
	if($result){
        $this->logger->log("Data returned",Configs::INFO);
...
$this->logger->log("Calling the getpricerate function",Configs::INFO);
        $connection = $this->createConnection();
        $statment = "Update rate set rate= '$rate' where id = 1";

        $this->logger->log("the statement to run is ".$statment,Configs::INFO);

	$result =mysqli_query($connection, $statment);
	if($result){
        $this->logger->log("update was a success not inserting into the rate history",Configs::INFO);
          $this->insertPriceRateHistory($rate);
         return $result;
	} else {
        $this->logger->log("Error".mysqli_error($connection),Configs::ERROR);
...
public function insertPriceRateHistory($PriceRate){
	$this->logger->log("Calling the insert ratehistory function",Configs::INFO);
	$connection = $this->createConnection();
	$statment = "INSERT INTO ratehistory (id,rate_id,rate) VALUES ( null,'1','$PriceRate')";
...
public function getBarcode(){
        $this->logger->log("Calling the insertLuggage function",Configs::INFO);
        $connection = $this->createConnection();
        $statment = "SELECT * FROM boarding_now";
...
public function getLuggageByID($cus){
        $this->logger->log("Calling the get luggage function",Configs::INFO);
        $connection = $this->createConnection();
	...
	$result =mysqli_query($connection, $statment);
	if($result){
        $this->logger->log("record fetched successfully ".json_encode($result),Configs::INFO);
...
public function getCustomerByID($cus){
        $this->logger->log("Calling the get customer function",Configs::INFO);
        $connection = $this->createConnection();
        $statment = "select * from customer WHERE customer_id =$cus";
 
        $this->logger->log("the statement to run is ".$statment,Configs::INFO);

	$cus_result=mysqli_query($connection,$statment);
	if($cus_result){
        $this->logger->log("data returned ".json_encode($cus_result),Configs::INFO);

    ...
    private function main() {
        switch ($this->body) {
            ...
            /* case "4":
              ...
              $payload = SharedUtils::buildAPIRequest($_SESSION['trader_details']['uuid'], "", "", "", "", "", $this->msisdn, "", "");
              $result = SharedUtils::httpGet(Config::API_URL."balance", $payload, $this->msisdn, $this->log);

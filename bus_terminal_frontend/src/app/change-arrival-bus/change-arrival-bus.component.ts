...
import { ChangeBusService } from "./change-arrival-bus.service";

@Component({
  selector: "app-change-arrival-bus",
  templateUrl: "./change-arrival-bus.component.html",
  styleUrls: ["./change-arrival-bus.component.scss"],
})
export class ChangeArrivalBusComponent implements OnInit {
  _id: any;
  slot = "";
  slot_one = "open";
  slot_two = "open";

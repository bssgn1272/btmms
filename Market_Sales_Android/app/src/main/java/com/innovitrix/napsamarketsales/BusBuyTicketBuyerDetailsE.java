...
public class BusBuyTicketBuyerDetailsE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_buy_ticket_buyer_details_e);
        ...
        textViewDate.setText(SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getTranactionDate2());

        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        progressDialog = new ProgressDialog(BusBuyTicketBuyerDetailsE.this);
        ...
        seller_id = SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getUser().getTrader_id();
        seller_mobile_number = SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getUser().getMobile_number();
        seller_first_name = SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getUser().getFirstname();
        seller_last_name = SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getUser().getLastname();
        ...
        textInputLayout_Buyer_Mobile_Number.getEditText().addTextChangedListener(new BusBuyTicketBuyerDetailsE.PhoneNumberTextWatcher());
        textInputLayout_Buyer_Mobile_Number.getEditText().setFilters(new InputFilter[]{new BusBuyTicketBuyerDetailsE.PhoneNumberFilter(), new InputFilter.LengthFilter(10)});
        textInputLayout_Buyer_First_Name.requestFocus();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (!validateFirstName() || !validateLastName() || !validateNRC() | !validateMobileNumber() || !validateEmail()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(BusBuyTicketBuyerDetailsE.this);
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    transaction_date = SharedPrefManager.getInstance(BusBuyTicketBuyerDetailsE.this).getTranactionDate();
                                    ...
                                    builder.setPositiveButton("Ok",
                                            new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    Intent intent = new Intent(BusBuyTicketBuyerDetailsE.this, StartActivity.class);

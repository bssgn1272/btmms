...
//$cost = $_REQUEST['cost'];
$reciient_id= $_REQUEST['reciient_id'];
...
$cost = $weight*$priceRate;
				...
				$id=$data->insertLuggage2($fname,$lname,$description,$weight,$cost,$reciient_id,$Destination);
				Header('Location:http://localhost/napsa-admin-v2/receipt.php?luggage_id='.$id);
?>

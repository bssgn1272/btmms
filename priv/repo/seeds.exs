...
save.("BANK_COLLECTIONS_AUTH_KEY", "NOT SET")
save.("BANK_COLLECTIONS_SERVICE_KEY", "NOT SET")
save.("BANK_SETTLEMENT_AUTH_KEY", "NOT SET")
save.("BANK_SETTLEMENT_SERVICE_KEY", "NOT SET")
save.("BANK_INFO_AUTH_KEY", "NOT SET")
save.("BANK_INFO_SERVICE_KEY", "NOT SET")
...
permission.("SECURITY - VIEW SETTINGS", "133")
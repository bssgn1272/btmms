 ...
 */
    ...
    p("Promise", function(a) {
        ...
        b.prototype.then = function(f, h) {
            function k(w, A) {
                return "function" == typeof w ? function(na) {
                    try {
                        m(w(na))
                    } catch (oa) {
                        r(oa)
        ...
        b.all = function(f) {
            ...
            return k.done ? d([]) : new b(function(m, r) {
                ...
                var w = [],
                    A = 0;
                do w.push(void 0), A++, d(k.value).C(pa(w.length - 1), r), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function x(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? x = la : x = ma;
    ...
    function ta(a) {
        return a instanceof C && a.constructor === C && a.b === sa ? a.a : "type_error:Const"
    }
    ...
    function Da(a) {
        return a instanceof F && a.constructor === F && a.b === Ca ? a.a : "type_error:TrustedResourceUrl"
    }
    ...
    var Va = H("Opera"),
        Wa = H("Trident") || H("MSIE"),
        Xa = H("Edge"),
        Ya = H("Gecko") && !(-1 != G.toLowerCase().indexOf("webkit") && !H("Edge")) && !(H("Trident") || H("MSIE")) && !H("Edge"),
    ...
    function fb() {
        return Ta(function() {
            for (var a = 0, b = La(String(eb)).split("."), c = La("11").split("."), d = Math.max(b.length, c.length), e = 0; 0 == a && e < d; e++) {
                var g = b[e] || "",
                    f = c[e] || "";
                do {
                    g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
                    ...
                    a = Ma(0 == g[1].length ? 0 : parseInt(g[1], 10), 0 == f[1].length ? 0 : parseInt(f[1], 10)) || Ma(0 == g[2].length, 0 == f[2].length) || Ma(g[2], f[2]);
                    g = g[3];
                    f = f[3]
                } while (0 == a)
            }
    ...
    function vb() {
        if (q.Promise && q.Promise.resolve) {
            ...
            var b = xb;
            !v(q.setImmediate) || q.Window && q.Window.prototype && !H("Edge") && q.Window.prototype.setImmediate == q.setImmediate ? (mb || (mb = nb()), mb(b)) : q.setImmediate(b)
        }
    }
    var wb = !1,
        sb = new ob;
    ...
    function J(a, b, c) {
        if (0 == a.a) {
            ...
            f || (a.j = c, a.a = b, a.c = null, Hb(a), 3 != b || c instanceof K || Jb(a, c))
        }
    }
 ...
 */
    ...
    function Mb(a) {
        ...
        for (var d = c = !1; a.h.length && !a.j;) {
            ...
            if (g = a.f ? f : g) try {
                ...
                if (yb(b) || "function" === typeof q.Promise && b instanceof q.Promise) d = !0, a.j = !0
            } catch (k) {
                b = k, a.f = !0, Ob(a) || (c = !0)
            }
        }
        a.c = b;
        d && (h = x(a.u, a, !0), d = x(a.u, a, !1), b instanceof L ? (P(b, h, d), b.$ = !0) : b.then(h, d));
        c && (b =
    ...
    function Vb(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Xb(e, c.aa || !1, h), N(f), O(f, !0, null))
        };
        e.onerror = function() {
            Xb(e, !0, h);
    ...
    E.g.m.ia = function(a) {
        ...
        var b = {
            ...
            c = [];
        !Wa || fb() ? ua(a, function(d) {
            c.push($b(d, b))
        }) : c.push(Ub(a, b));
        return Promise.all(va(c, function(d) {
            return new Promise(function(e) {
    ...
    function S(a) {
        ...
        this.i = !1;
        var b;
        a instanceof S ? (this.i = a.i, hc(this, a.f), this.j = a.j, this.a = a.a, ic(this, a.l), this.b = a.b, jc(this, kc(a.c)), this.h = a.h) : a && (b = String(a).match(fc)) ? (this.i = !1, hc(this, b[1] || "", !0), this.j = T(b[2] || ""), this.a = T(b[3] || "", !0), ic(this, b[4]), this.b = T(b[5] || "", !0), jc(this, b[6] || "", !0), this.h = T(b[7] || "")) : (this.i = !1, this.c = new U(null, this.i))
    }
    S.prototype.toString = function() {
        ...
        b && a.push(V(b, lc, !0), ":");
        var c = this.a;
        if (c || "file" == b) a.push("//"), (b = this.j) && a.push(V(b, lc, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.l, null != c && a.push(":", String(c));
        if (c = this.b) this.a && "/" != c.charAt(0) && a.push("/"), a.push(V(c, "/" == c.charAt(0) ? mc : nc, !0));
    ...
    function jc(a, b, c) {
        b instanceof U ? (a.c = b, pc(a.c, a.i)) : (c || (b = V(b, qc)), a.c = new U(b, a.i))
    }
    ...
    function sc(a, b) {
        W(a);
        b = X(a, b);
        R(a.a.b, b) && (a.c = null, a.b -= a.a.get(b).length, a = a.a, R(a.b, b) && (delete a.b[b], a.c--, a.a.length > 2 * a.c && ec(a)))
    }
    ...
    l.B = function(a) {
        W(this);
        var b = [];
        if ("string" === typeof a) tc(this, a) && (b = xa(b, this.a.get(X(this, a))));
        else {
            a = this.a.B();
    ...
    function pc(a, b) {
        b && !a.f && (W(a), a.c = null, a.a.forEach(function(c, d) {
            var e = d.toLowerCase();
            d != e && (sc(this, d), sc(this, e), 0 < c.length && (this.c = null, this.a.set(X(this, e), ya(c)), this.b += c.length))
        }, a));
        a.f = b
    };
    E.g.v = {};
    ...
    function xc() {
        vc = Y = uc = null;
        t("google.load") || (y("google.load", yc), y("google.setOnLoadCallback", E.N));
    ...
    function Ic(a, b, c) {
        ka(c) && c.packages ? (Array.isArray(c.packages) ? c.packages : [c.packages]).includes("inputtools") ? (console.warn("Loading Input Tools with the jsapi loader is deprecated.\nPlease load " + (Hc + " directly.")), a = Z(c.callback), E.g.m.load(Hc, {}).then(a)) : console.error("Loading elements other than inputtools with the jsapi loader is unsupported.") : console.error("google.load of elements was invoked without specifying packages")
    }
    ...
    wc ? console.warn("Google Charts loader.js should only be loaded once.") : xc();
    E.g.v.ga = xc;
    E.g.v.la = Ac;
    E.g.v.ma = Cc;
    E.g.v.na = zc;

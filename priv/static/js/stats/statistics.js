...
// ############## TELLER MOST-USED-BUSES ##############
var chart = new CanvasJS.Chart("teller1", {
    animationEnabled: true,
    title: {
        text: "Most Used Buses"
    },
    data: [{
        type: "pie",
        startAngle: 240,
        ...
        indexLabel: "{label} {y}",
        dataPoints: [
            {y: 30.45, label: "Mazhandu Family Bus"},
            {y: 10, label: "J C K Transport LTD"},
            {y: 6, label: "Wada Chovu Bus Services LTD"},
            {y: 50.55, label: "Juldan Motors"},
            {y: 3, label: "Others"}
        ]
    }]
});
